...
def create_word2vec_model(posts, num_threads, feature_size, min_words,
                          distance_between_words, epochs):
...
if __name__ == "__main__":
    ...
    # model = create_word2vec_model(posts, 4, 300, 10, 10,
    # 10)  #comment out this line after ran once
